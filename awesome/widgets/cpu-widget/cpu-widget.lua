...
local function create_textbox(args)
    return wibox.widget {
        ...
        markup = args.markup,
        forced_width = args.forced_width or 100,
...
local function create_process_header(params)
    local res = wibox.widget {
        ...
        },
        {
            ...
            params.with_action_column and create_textbox {
                forced_width = 20
            } or nil,
...
local function worker(user_args)
    ...
    watch(CMD_slim, timeout, function(widget, stdout)
        ...
        local _, user, nice, system, idle, iowait, irq, softirq, steal, _, _ = stdout:match(
                ...
                if starts_with(line, 'cpu') then
                    ...
                    if is_update == true then
                        ...
                        if enable_kill_button then
                            ...
                            kill_proccess_button:buttons(awful.util.table.join(
            ...
            popup:setup{
                {
                    ...
                    create_process_header {
                        with_action_column = enable_kill_button
                    },
                    process_rows,
                    layout = wibox.layout.fixed.vertical
                },

...
ColumnLayout {
    ...
    Repeater {
        model: Pipewire.nodes.values.filter(n => !n.isSink && !n.isStream && n.audio != null).sort((a, b) => {
            if (a === Pipewire.defaultAudioSource)
                return -1;
            if (b === Pipewire.defaultAudioSource)
                return 1;
            ...
            sourceComponent: Rectangle {
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        CheckBox {
                            id: defaultCheck
                            checked: delegateItem.modelData == Pipewire.defaultAudioSource
                            implicitHeight: 20
                            implicitWidth: 20
                            ...
                            MouseArea {
                                ...
                                onClicked: {
                                    Pipewire.preferredDefaultAudioSource = delegateItem.modelData;
                                }
                            }
                        }
                    }
                        ...
                        Button {
                            ...
                            contentItem: Text {
                                ...
                                function getColor(source) {
                                    if (source.audio.muted || isNaN(source.audio.volume)) {
                                        return "#f38ba8";
                                    } else {
                                        return "#89dceb";
                                    }
